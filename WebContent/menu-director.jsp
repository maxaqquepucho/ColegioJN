               ...
               <aside class="sidebar" data-color="green" data-image="/images/sidebar-2.jpg"
                   ...
                   <div class="" style="background-color: rgba(0,0,0,0.6); height:100%;">
                       <div class="logo">
                           ...
                           <a class="simple" href="menu.jsp">JES�S DE NAZARETH</a>
                       </div>
                       <hr>
                                      ...
                                      <div class="card-body d-flex justify-content-around">
											...
											<div class="table-responsive">
    											...
    											%>
                                                    <tbody>
                                                        <tr>
                                                            <th scope="row"><%=rs2.getInt("idPersona")%></th>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-info" href="Editar.jsp?id=<%=rs2.getInt("idPersona")%>" >Editar</a>
                                                            </td>
                                                            <td>
                                                                <a class="btn btn-secondary" href="Eliminar.jsp?id=<%=rs2.getInt("idPersona")%>">Eliminar</a>
                                                            </td>
                                                        </tr>
